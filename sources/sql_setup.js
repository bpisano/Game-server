class SQLSetup {
    ...
    static setup() {
        ...
        .then(() => sql.createTable("players (`id` VARCHAR(255) PRIMARY KEY NOT NULL, `username` VARCHAR(255) NOT NULL, gameId VARCHAR(255) DEFAULT NULL, `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)"))
        .catch(error => {
            console.log(error)
        })
    }
